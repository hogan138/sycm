...
public class InviteSharePopupUtil {
                            ...
                            case R.layout.share_popupwindow:
                                ...
                                ivWeChat.setOnClickListener(new OnMultiClickListener() {
                                    ...
                                    public void onMultiClick(View v) {
                                        ...
                                        loadInviteShared(SHARE_CHANNEL, context, view);//微信分享
                                    }
                                });
                                ivFriends.setOnClickListener(new OnMultiClickListener() {
                                    ...
                                    public void onMultiClick(View v) {
                                        ...
                                        loadInviteShared(AppConst.SHARE_MEDIA_WEIXIN_CIRCLE, context, view);//微信朋友圈分享
                                    }
                                });
                                ivqr.setOnClickListener(new OnMultiClickListener() {
                                    ...
                                    public void onMultiClick(View v) {
                                        ...
                                        //二维码分享
                                        loadInviteShared(AppConst.SHARE_MEDIA_QR, context, view);//二维码分享
                                    }
                                });
