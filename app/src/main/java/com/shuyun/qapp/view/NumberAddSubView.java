...
public class NumberAddSubView extends LinearLayout implements View.OnClickListener {
    ...
    public NumberAddSubView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            @SuppressLint("RestrictedApi") int value = a.getInt(R.styleable.NumberAddSubView_value, 0);
            setValue(value);

            @SuppressLint("RestrictedApi") int maxValue = a.getInt(R.styleable.NumberAddSubView_maxValue, 0);
            setMaxValue(maxValue);

            @SuppressLint("RestrictedApi") int minValue = a.getInt(R.styleable.NumberAddSubView_minValue, 0);
            setMinValue(minValue);

            @SuppressLint("RestrictedApi") Drawable btnSubBackground = a.getDrawable(R.styleable.NumberAddSubView_btnSubBackground);
            if (btnSubBackground != null)
                btn_sub.setBackground(btnSubBackground);

            @SuppressLint("RestrictedApi") Drawable btnAddBackground = a.getDrawable(R.styleable.NumberAddSubView_btnAddBackground);
            if (btnAddBackground != null)
                btn_sub.setBackground(btnAddBackground);

            @SuppressLint("RestrictedApi") Drawable textViewBackground = a.getDrawable(R.styleable.NumberAddSubView_textViewBackground);
