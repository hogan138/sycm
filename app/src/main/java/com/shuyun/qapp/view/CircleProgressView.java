...
public class CircleProgressView extends View {
    ...
    private static Paint mPaintOut;
    private Paint mPaintCurrent;
    private Paint mPaintText;
    private static float mPaintWidth;//画笔宽度
    private int mPaintColor = Color.RED;//进度条颜色
    ...
    public CircleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPaintOut.setColor(Color.parseColor("#FFD149"));
...
//        String text = mCurrent + "%";
    ...
    public static void updateColor() {
        mPaintOut.setColor(Color.parseColor("#da543f"));
    }
