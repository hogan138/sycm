 ...
 * ganquan
 */
public class AllPrizeFragment extends Fragment {
    ...
    public static AllPrizeFragment newInstance(int certification) {
        Bundle args = new Bundle();
        args.putInt("certification", certification);
        AllPrizeFragment fragment = new AllPrizeFragment();
